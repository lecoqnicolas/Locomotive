...
def test_ensemble_model():
    ...
    # Inputs
    prompts = ["Hello, how are you?", "another_sentence", "Je suis Triton"]
    ...
    # Set Inputs
    client.infer(model_name="ensemble_model", texts=prompts, src_lang=src, tgt_lang=targets, callback=callback)
